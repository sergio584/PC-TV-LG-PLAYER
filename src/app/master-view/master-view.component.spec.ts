...
describe('MasterViewComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [MasterViewComponent, NoopAnimationsModule, FormsModule, ReactiveFormsModule, RouterTestingModule, IGX_NAVBAR_DIRECTIVES, IgxIconButtonDirective, IgxIconComponent, IGX_NAVIGATION_DRAWER_DIRECTIVES, IgxSnackbarComponent]
    })
    .compileComponents();
